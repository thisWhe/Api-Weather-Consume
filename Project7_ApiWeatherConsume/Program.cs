...
if(number == "4")
{
    ...
    Console.Write("Silme istediginiz Id Değeri: ");
...
if(number == "6")
{
    ...
    using (HttpClient client = new HttpClient())
    {
        ...
        Console.WriteLine("Girmiş Oldugunuz Id değerine ait bilgiler");
        Console.WriteLine();
...
//https://localhost:7277/api/Weathers/GetByIdWeatherCity?id=5